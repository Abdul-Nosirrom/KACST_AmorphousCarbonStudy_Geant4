...
int main(int argc, char** argv)
{
    ...
    // Register scoring manager so scoring_mesh.mac commands can execute, without they are not found
    G4ScoringManager::GetScoringManager();   // activate command-based scoring (/score/...)
